...
public class Tool {
   ...
   * 이미지 사이즈를 변경하여 새로운 이미지를 생성합니다.
   <pre>
   사용예): Too.imgResize(srcFile 객체, destFile 객체, 200, 150)
   </pre>
   * @param src 원본 이미지 파일
...
/*    File src = new File("C:/iot1/temp/tu04.jpg");
    File dest = new File("C:/iot1/temp/tu04_1.jpg");
    int width = 200;
    int height = 150;
    
    String file = imgResize(src, dest, width, height);
