...
public class Log {
  public static synchronized void w(String str){
    ...
    if (os.indexOf("Window") >= 0){
      path = "C:/iot1/ws_web/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/blog_v2jq/log";
    }else{
      path="/home/hosting_users/soldeskit4/tomcat/webapps/ROOT/log";
    }
