...
function send(){
  ...
  if (document.frm.agree.checked == false){
    alert('관리자 약관에 동의해야 관리자 가입이 가능합니다.');
...
<!-- onsubmit 이벤트는 form이 submit이 될 때 발생함. 
     send( )함수 실행 ▶ false ▶ submit 중지
     send( )함수 실행 ▶ true  ▶ create_form.jsp로 서브밋 이동 
 --> 
<form name="frm" method="post" action="./create_form.jsp"  
      onsubmit="return send();"> 
 
<div class='title' style='width: 20%;'>약관동의</div> 
 
<DIV class='content' style="text-align: center;">
  <textarea cols="90" rows="14" readonly="readonly" style='resize: none;'>Community 서비스약관 (2005. 7. 18 부터 유효) 
 
제1조(목적 등) 
 
  
① Community (www.www_pilot.co.kr) 서비스 약관(이하 "본 약관"이라 합니다)은 이용자가 ㈜ www_pilot(이하 "Community"이라 합니다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 합니다)를 이용함에 있 어 이용자와 "Community"의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. 
