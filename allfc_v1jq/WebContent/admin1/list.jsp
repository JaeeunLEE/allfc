...
<TABLE class='table'>
  <TR>
    ...
    <TH class='th' style='width: 20%;'>이메일확인</TH>
    <TH class='th' style='width: 10%;'>등록일</TH>
...
%> 
  <TR>
    ...
    <TD class='td'>
      ...
      <A href="javascript:passwd_form(<%=admin1no %>)"><IMG src='../menu/images/passwd.png' title='패스워드 변경'></A>
      <A href="javascript:update_form(<%=admin1no %>,'<%=email %>')"><IMG src='../menu/images/gear.png' title='수정'></A>
      <A href="javascript:delete_form(<%=admin1no %>)"><IMG src='../menu/images/cancel.png' title='삭제'></A>
    </TD>
